-- ═══════════════════════════════════════════════════════════════════
-- Smart Bursar System — MySQL Schema & Seed Data
...
INSERT INTO `expenses` (`id`, `expense_no`, `description`, `category`, `amount`, `vendor`, `reference`, `expense_date`, `term_id`, `status`, `submitted_by`, `approved_by`, `approved_at`, `notes`, `created_at`, `updated_at`, `school_id`) VALUES
  ...
  (3, 'EXP-2025-003', 'Internet Bill — MTN', 'Utilities', 45000, 'MTN Business', NULL, '2025-02-20 22:00:00', 1, 'Pending', 2, NULL, NULL, NULL, '2026-02-27 09:49:36', '2026-02-27 09:49:36', 1),
